...
public class Step02_05_GenVSM_full {
...
//		String[] tokensStr  = tempLine.split("\t");
		...
		String wordMapStr = tardataPathStr+"/Step02_05_usrWordDict_full.lst";
		
		String vsmBW_TrainStr = tardataPathStr+"/Step02_06_Train_full.VSM";
		String vsmBW_TestStr = tardataPathStr+"/Step02_06_Test_full.VSM";

		BufferedReader dataTrainFile = new BufferedReader(new InputStreamReader(
				new FileInputStream(new File(srcDataPathStr+
						"Step02_04_Train_fea_full.dat")), "UTF-8"));
		BufferedReader dataTestFile = new BufferedReader(new InputStreamReader(
				new FileInputStream(new File(srcDataPathStr+
						"Step02_04_Test_fea_full.dat")), "UTF-8"));
